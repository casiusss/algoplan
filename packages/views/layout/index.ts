...
// from the new module so any unmigrated consumer of @algoplan/views/layout keeps
// working. New code should import from @algoplan/views/dashboard-shell directly.
