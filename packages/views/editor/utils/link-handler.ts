...
import { isGlobalPath } from "@algoplan/core/paths";
...
/**
 * Open a link — internal paths dispatch algoplan:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("algoplan:navigate", { detail: { path } }),
    );
  } else {
