...
import { captureEvent, setPersonProperties } from "@algoplan/core/analytics";
  ...
  return (
    <div>
      ...
      <p className="mt-4 max-w-[560px] text-[15.5px] leading-[1.55] text-muted-foreground">
        AlgoPlan drives local AI coding tools like{" "}
...
function EmptyView({
  ...
  // and nudging the user to install one would frame AlgoPlan as a
