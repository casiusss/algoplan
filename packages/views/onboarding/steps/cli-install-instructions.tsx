...
const SETUP_CMD = "algoplan setup";
 ...
 * script, step 2 is the cloud `algoplan setup` which the CLI itself knows
  ...
  return (
    <Card className="w-full">
      <CardContent className="space-y-4 pt-4">
        ...
        <Step n={1} label="Install the AlgoPlan CLI" cmd={INSTALL_CMD} />
