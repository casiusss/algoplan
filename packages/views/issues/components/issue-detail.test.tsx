...
import type { Issue, TimelineEntry } from "@algoplan/core/types";
// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @algoplan/core/hooks.tsx). vi.mock("@algoplan/core/paths") only intercepts
...
// Mock @algoplan/core/workspace/hooks
...
// Mock @algoplan/core/paths — after the URL-driven workspace refactor,
...
// Mock realtime
vi.mock("@algoplan/core/realtime", () => ({
  useWSEvent: vi.fn(),
...
// Mock react-resizable-panels (used by @algoplan/ui/components/ui/resizable)
