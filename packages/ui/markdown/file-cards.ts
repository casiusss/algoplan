 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "algoplan-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "algoplan-static.copilothub.ai")
 */
