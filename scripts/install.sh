...
#   curl -fsSL https://raw.githubusercontent.com/casiusss/algoplan/main/scripts/install.sh | bash -s -- --with-server
#
...
# Configuration
# ---------------------------------------------------------------------------
REPO_URL="https://github.com/casiusss/algoplan.git"
REPO_WEB_URL="https://github.com/casiusss/algoplan"  # without .git, for GitHub web APIs
...
detect_os() {
  ...
  irm https://raw.githubusercontent.com/casiusss/algoplan/main/scripts/install.ps1 | iex" ;;
...
install_cli_binary() {
  ...
  local url="https://github.com/casiusss/algoplan/releases/download/${latest}/multica-cli-${version}-${OS}-${ARCH}.tar.gz"
  local tmp_dir
  tmp_dir=$(mktemp -d)
...
setup_server() {
  ...
  info "Building Multica images from source (this may take a few minutes on first run)..."
...
run_default() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/casiusss/algoplan/main/scripts/install.sh | bash -s -- --with-server\n"
  printf "\n"
}
...
run_with_server() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/casiusss/algoplan/main/scripts/install.sh | bash -s -- --stop\n"
  printf "\n"
}
