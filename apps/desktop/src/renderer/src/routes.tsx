...
import { IssuesPage } from "@algoplan/views/issues/components";
import { ProjectsPage } from "@algoplan/views/projects/components";
import { AutopilotsPage } from "@algoplan/views/autopilots/components";
import { MyIssuesPage } from "@algoplan/views/my-issues";
import { SkillsPage } from "@algoplan/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@algoplan/views/agents";
import { InboxPage } from "@algoplan/views/inbox";
import { SettingsPage } from "@algoplan/views/settings";
