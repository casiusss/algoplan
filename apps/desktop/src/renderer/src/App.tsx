...
import { workspaceKeys, workspaceListOptions } from "@algoplan/core/workspace/queries";
...
function AppContent() {
  ...
  // Listen for invite IDs delivered via deep link (algoplan://invite/<id>).
  ...
  // Listen for auth token delivered via deep link (algoplan://auth/callback?token=...).
