#!/usr/bin/env node
// Builds the `algoplan` CLI from server/cmd/algoplan and copies the binary
...
//
// ldflags mirror `make build` so `algoplan --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "algoplan.exe" : "algoplan";
}
