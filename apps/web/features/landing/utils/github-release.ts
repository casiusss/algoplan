...
/**
 * Server-side fetcher for the latest AlgoPlan release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/casiusss/algoplan/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — AlgoPlan doesn't publish prereleases or drafts
