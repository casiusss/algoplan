...
const SAMPLE_LATEST_ASSET = {
  name: "algoplan-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/casiusss/algoplan/releases/download/v0.2.14/algoplan-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "algoplan-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/casiusss/algoplan/releases/download/v0.2.13/algoplan-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/casiusss/algoplan/releases/tag/${overrides.tag}`,
