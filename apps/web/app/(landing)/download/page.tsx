...
export const metadata: Metadata = {
  title: "Download AlgoPlan",
  description:
    "Download AlgoPlan for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download AlgoPlan",
    description:
      "Get the AlgoPlan desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
